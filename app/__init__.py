...
app = Flask(__name__)
app.config['SQLALCHEMY_DATABASE_URI'] = f"mysql+mysqlconnector://tk77gwrcldsuov2jt0sq:pscale_pw_mEEFEHCcYSwvJZRhITrIqm9IOSSlryD0moVocktZt8t@aws.connect.psdb.cloud:3306/inuka"
